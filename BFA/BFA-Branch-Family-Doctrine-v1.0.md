...
1. Gộp **chi** (đơn vị tổ chức họ) với **gia đình** (hộ trực hệ của một người).
2. Gộp **Tổ nghiệp** (người đời ≤ n, đã đứng sổ) với **người khai chi** (đời n+1, mở hồ sơ).
3. Gộp **vai trên sổ** (Founder / Origin) với **tài khoản và quyền ghi** (`users.status`, EDITOR).
...
| Trạng thái chi | Founder / EDITOR tháo `branch_id` |
|---|---|
| DRAFT, PROVISIONAL, REJECTED | Được, trong tenant |
| SUBMITTED, UNDER_REVIEW | Không — đang xét |
| APPROVED, MERGED | Không tự do. Proposal hoặc Admin |
